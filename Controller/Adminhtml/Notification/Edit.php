...
class Edit extends \Bluethinkinc\CatalogStockStatus\Controller\Adminhtml\Notification
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('bluethinkinc_catalogstockstatus_notification', $model);
